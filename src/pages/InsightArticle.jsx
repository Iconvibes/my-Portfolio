...
const bodyClass = {
  p: 'text-base leading-8 text-secondary',
  h2: 'display-ink pt-4 text-2xl text-paper',
  ul: 'space-y-2.5 text-base leading-7 text-secondary',
  quote: 'border-l-2 border-accent/60 pl-6 text-lg italic leading-8 text-secondary'
};
  ...
  if (!insight) {
    return (
      <div className="mx-auto max-w-3xl px-6 py-24 text-center sm:px-8">
        <h1 className="display-ink text-3xl text-paper">Essay not found</h1>
        <p className="mt-4 text-secondary">That article does not exist, yet.</p>
        <div className="mt-8">
    ...
    <div className="bg-ink text-paper">
      <article className="mx-auto max-w-3xl px-5 py-12 sm:px-6 sm:py-16 md:px-8 lg:py-24">
        ...
        <div className="mt-8 flex flex-wrap items-center gap-x-4 gap-y-2">
          ...
          <span className="mono-label text-secondary">{insightDate(insight.published)}</span>
          <span className="mono-label text-secondary">{readingTime(insight)} min read</span>
        </div>

        <h1 className="display-ink mt-6 text-4xl text-paper sm:text-5xl">{insight.title}</h1>
        <p className="mt-6 text-lg leading-8 text-secondary">{insight.summary}</p>
        ...
        <footer className="mt-14 border-t border-line pt-8">
          <p className="mono-label text-secondary">// about the author</p>
