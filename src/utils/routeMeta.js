...
export const routeMeta = [
  ...
  },
  {
    ...
    seo: {
      title:
        "About Ferdinard Ashonibare | Full-Stack Web Developer — Lagos, Nigeria",
      description:
        "Learn about Ferdinard Ashonibare — a full-stack web developer from Lagos, Nigeria building secure platforms for government, hospitality, education, and real estate.",
      ogImage: "/og-about.jpg",
      keywords: [
        "about Ferdinard Ashonibare",
        "full-stack developer",
        "Lagos developer",
        "Nigeria web developer",
        "Ashonibare developer",
      ],
    },
  },
  {
  ...
  },
  {
    ...
    seo: {
      title:
        "Case Study: So-Safe Corps | Ferdinard Ashonibare — Full-Stack Developer",
      description:
  ...
  },
  {
    ...
    seo: {
      title:
        "Insights & Articles | Ferdinard Ashonibare — Full-Stack Developer",
      description:
  ...
  },
  {
    ...
    seo: {
      title:
        "Contact Ferdinard Ashonibare | Hire Full-Stack Developer — Lagos, Nigeria",
      description:
        "Get in touch with Ferdinard Ashonibare — hire a full-stack web developer in Lagos, Nigeria for websites, web apps, and projects.",
      ogImage: "/og-contact.jpg",
      keywords: [
        "contact Ferdinard Ashonibare",
        "hire web developer",
        "Lagos developer",
        "Nigeria developer for hire",
      ],
    },
  },
];
...
export const caseStudyRoutes = projects
  ...
  .map((project) => ({
    ...
    seo: {
      ...
      ogImage:
        csOgImages[project.slug] || project.image || siteConfig.defaultImage,
      keywords: [
        "case study",
        project.name,
        project.sector,
...
export const prerenderablePaths = allPublicPaths.filter(
  (path) => !path.includes(":"),
);
