...
export default function InfiniteScroll({
  ...
  return (
    <div
      ...
      style={{ maxHeight }}
    >
      <div className="absolute top-0 left-0 w-full h-1/4 bg-lineaar-to-b from-black/10 to-transparent z-10 pointer-events-none"></div>
      <div className="absolute bottom-0 left-0 w-full h-1/4 bg-linear-to-t from-black/10 to-transparent z-10 pointer-events-none"></div>
