...
//   ];
  ...
  return (
    <div
      ...
      className={`relative w-full h-full flex flex-wrap lg:grid lg:grid-cols-3 lg:w-[80%] lg:mx-auto justify-center items-start gap-3 bg-primary/5 py-5 lg:px-12 rounded-2xl ${className}`}
      style={{
        '--r': `${radius}px`,
        '--x': '50%',
        '--y': '50%'
      ...
      {data.map((c, i) => (
        ...
        >
          ...
          <div className="relative z-10 flex-1 p-2.5 box-border">
            <img src={c.image} alt={c.title} loading="lazy" className="w-full h-full lg:h-[300px] object-cover rounded-[10px]" />
          </div>
          <footer className="relative z-10 p-3 text-white font-roboto gap-y-1 mt-2 flex flex-col w-full bg-transparent">
